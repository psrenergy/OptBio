...
function build_case()
    filename = joinpath(@__DIR__, "test10.optbio")

    rm(filename, force = true)

    reference_capacity = 14400.0
    initial_availability = 3 * reference_capacity
    initial_capacity = reference_capacity / 2
...
function test_capacity_scale_limit_benders()
    reference_capacity,
    initial_availability,
    initial_capacity,
    maximum_scale_capacity,
    ...
    calculated_investment =
        investment_at_maximum_scale_capacity * initial_availability / maximum_scale_capacity -
...
function test_capacity_scale_limit_deterministic()
    reference_capacity,
    initial_availability,
    initial_capacity,
    maximum_scale_capacity,
...
TestCapacityScaleLimit.runtests()
