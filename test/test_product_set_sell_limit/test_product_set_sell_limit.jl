module TestSumOfProductsConstraint
...
function build_case()
    filename = joinpath(@__DIR__, "test12.optbio")
...
function test_sum_of_products_constraint_benders()
    build_case()
    filename = joinpath(@__DIR__, "test12.optbio")
...
function test_sum_of_products_constraint_deterministic()
    build_case()
    filename = joinpath(@__DIR__, "test12.optbio")
...
TestSumOfProductsConstraint.runtests()
