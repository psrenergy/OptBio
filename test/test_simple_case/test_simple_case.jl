...
function build_case()
    filename = joinpath(@__DIR__, "test0.optbio")
...
function test_simple_case_benders()
    build_case()
    filename = joinpath(@__DIR__, "test0.optbio")
...
function test_simple_case_deterministic()
    build_case()
    filename = joinpath(@__DIR__, "test0.optbio")
